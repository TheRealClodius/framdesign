...
export async function execute(context) {
  ...
  try {
    ...
    try {
      ...
      // Use relative paths - in voice-server context, lib is at ../../lib
      const embeddingPath = '../../lib/services/embedding-service.ts';
      const vectorPath = '../../lib/services/vector-store-service.ts';

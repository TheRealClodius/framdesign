...
- **Use appropriately**: Only when conversation naturally concludes or user explicitly requests.
- **Current session only**: Ignore historical mentions of “end session”; wait for a clear, current signal.

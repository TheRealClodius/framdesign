 ...
 *
 * NOTE: We intentionally use minimal subsets of schema features for provider formats.
 * Canonical JSON Schema (draft 2020-12) remains the source of truth for validation (Ajv).
 */
 ...
 *
 * We emit string enum values like "OBJECT", "STRING", etc.
 * This matches how `@google/genai`'s `Type.*` values serialize in existing artifacts.
 */
